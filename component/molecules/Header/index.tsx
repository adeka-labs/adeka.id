...
const MenuWrapper = tw.div`hidden sm:flex min-w-min items-center`;
...
const MenuMobile = tw.div`flex sm:hidden px-2 py-1 text-orange-dark w-12 h-12  items-center`;
  ...
  return (
    <Head>
      <Menu>
        ...
        <MenuMobile onClick={handleClose} id="menu-mobile">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
        ...
        <MenuWrapper>
          ...
          <Link href="https://github.com/adeka-factory" passHref>
