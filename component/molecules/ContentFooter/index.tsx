...
const ListBig = tw.div`flex flex-col col-span-5 justify-start items-start `;
const ListSmall = tw.div`flex flex-col col-span-3`;
...
const SocialContainer = tw.div`col-span-2 col-end-13 flex justify-evenly`;
